...
if (!asset) {
	console.error(
		`No prebuilt binary for platform=${platform} arch=${arch}. Falling back to source.`,
	);
	console.error(
		"Please install Go to build locally or use a supported platform.",
	);
...
const dest = path.join(
	binDir,
	asset.endsWith(".exe") ? "i18n-ai-translator.exe" : "i18n-ai-translator",
);
